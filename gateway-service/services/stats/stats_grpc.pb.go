...
func (c *statsClient) GetHTML(ctx context.Context, in *StatsReq, opts ...grpc.CallOption) (*StatsRes, error) {
	out := new(StatsRes)
	err := c.cc.Invoke(ctx, Stats_GetHTML_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStatsServer) GetHTML(context.Context, *StatsReq) (*StatsRes, error) {
...
func _Stats_GetHTML_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StatsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatsServer).GetHTML(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Stats_GetHTML_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatsServer).GetHTML(ctx, req.(*StatsReq))
	}
